 ...
 * 
 */
@WebServiceClient(name = "AuthorService", targetNamespace = "http://webservices.imrul.orgs/", wsdlLocation = "http://imrul-u30jc:8080/AgeProvider/AuthorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTHORSERVICE_QNAME = new QName("http://webservices.imrul.orgs/", "AuthorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://imrul-u30jc:8080/AgeProvider/AuthorService?wsdl");
    ...
    public Author getAuthorPort() {
        return super.getPort(new QName("http://webservices.imrul.orgs/", "AuthorPort"), Author.class);
    }
     ...
     */
    @WebEndpoint(name = "AuthorPort")
    public Author getAuthorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.imrul.orgs/", "AuthorPort"), Author.class, features);
    }
